...
for %%T in (discovery servicetest i2cscan i2cid proxmon lan8680 gpio gpioevents ledscan ledblink ledtoggle gpiomax ledpwm proxled spi spiid thumbmon adc pwm uart boot flashimg flashpkg clickdemo diag video dncpmon dncpdisc) do (
