...
for %%T in (discovery i2cscan i2cid proxmon lan8680 gpio ledscan ledblink ledtoggle ledpwm proxled spi spiid thumbmon adc pwm boot flashimg flashpkg clickdemo diag video dncpmon dncpdisc) do (
